...
class NetRequestFactory(builder: Builder) {
    ...
    class Builder(val net: Net) {
        ...
        fun partString(name: String, value: String, mediaType: okhttp3.MediaType = HttpHeaders.MEDIA_TYPE_PLAIN, encoding: String = "binary") =
            apply {
                partBody(name, value.toRequestBody(mediaType), encoding)
            }

        fun partString(name: String, values: List<String>, mediaType: okhttp3.MediaType = HttpHeaders.MEDIA_TYPE_PLAIN, encoding: String = "binary") =
            apply {
                for (value in values) {
        ...
        fun partByteArray(
            name: String,
            value: ByteArray,
            contentType: okhttp3.MediaType = HttpHeaders.MEDIA_TYPE_STREAM,
