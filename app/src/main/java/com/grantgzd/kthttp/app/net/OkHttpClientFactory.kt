...
//            .addNetworkInterceptor(WriteCache())
    ...
    inner class AddCookiesInterceptor : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            ...
            for (cookie in cookies) {
                ...
                Log.i("OkHttpClientFactory", "AddCookiesInterceptor:Adding Header:$cookie")
            }
        ...
        override fun intercept(chain: Interceptor.Chain): Response {
            ...
            if (!NetworkUtil.isConnected()) {
                ...
                request = request.newBuilder()
                    ...
                    .build()
                Log.e("OkHttpClientFactory", "GetCache:intercept:no network ")
            }
    ...
    inner class WriteCache : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            ...
            Log.i("OkHttpClientFactory", "WriteCache:intercept ")
