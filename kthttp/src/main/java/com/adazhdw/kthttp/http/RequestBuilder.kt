...
import com.adazhdw.kthttp.internal.HttpHeaders
...
internal class RequestBuilder(
    ...
    private val requestBuilder: okhttp3.Request.Builder = okhttp3.Request.Builder()
    private val headersBuilder: okhttp3.Headers.Builder = headers?.newBuilder() ?: okhttp3.Headers.Builder()
    ...
    init {
        if (isFormEncoded) {
            ...
            multipartBuilder = okhttp3.MultipartBody.Builder()
    ...
    internal fun addHeaders(headers: okhttp3.Headers) {
        headersBuilder.addAll(headers)
    }

    internal fun addPathParam(params: Map<String, String>) {
    ...
    fun addPart(body: okhttp3.RequestBody) = apply {
        addPart(okhttp3.MultipartBody.Part.create(body))
    }

    /** Add a part to the body. */
    fun addPart(headers: okhttp3.Headers, body: okhttp3.RequestBody) = apply {
        addPart(okhttp3.MultipartBody.Part.create(headers, body))
    }

    /** Add a form data part to the body. *//*
    fun addFormDataPart(name: String, value: String) = apply {
        addPart(okhttp3.MultipartBody.Part.createFormData(name, value))
    }

    */
    /** Add a form data part to the body. *//*
    fun addFormDataPart(name: String, filename: String, body: okhttp3.RequestBody) = apply {
        addPart(okhttp3.MultipartBody.Part.createFormData(name, filename, body))
    }*/
    ...
    private class ContentTypeOverridingRequestBody(private val delegate: okhttp3.RequestBody, private val contentType: okhttp3.MediaType?) : okhttp3.RequestBody() {
